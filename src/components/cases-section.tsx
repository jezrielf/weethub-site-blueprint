...
export const CasesSection = () => {
  ...
  return <section className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        once: true
          ...
          <h2 className="text-3xl font-bold mb-4 bg-clip-text bg-gradient-to-r from-weethub-yellow to-yellow-600 text-[#ffd700] md:text-4xl">
            Cases de Sucesso
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          {featuredCases.map((case_, index) => <motion.div key={case_.id} initial={{
          opacity: 0,
          y: 50
        }} whileInView={{
          opacity: 1,
          ...
          once: true
              ...
              <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700 hover:border-weethub-yellow transition-all duration-300 group h-full overflow-hidden">
                <div className="relative overflow-hidden">
                  <img src={case_.image} alt={case_.title} className={`w-full object-cover group-hover:scale-110 transition-transform duration-300 ${case_.highlight ? "h-64" : "h-48"}`} />
