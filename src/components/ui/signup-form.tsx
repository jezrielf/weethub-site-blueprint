    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            "flex h-12 w-full rounded-lg border border-gray-800 bg-black px-4 py-3 text-sm text-white transition-all duration-300 file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-400 focus:border-weethub-yellow focus:outline-none focus:ring-2 focus:ring-weethub-yellow/20 disabled:cursor-not-allowed disabled:opacity-50",
            focused && "border-weethub-yellow",
            className,
          )}
          ref={ref}
        ...
        {focused && (
          <motion.div
            className="absolute inset-0 rounded-lg border-2 border-weethub-yellow pointer-events-none"
...
export const SignupForm = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-2xl bg-gradient-to-br from-gray-900 to-black p-8 shadow-2xl border border-gray-800">
      <motion.div
        ...
        >
          <LabelInputContainer>
            ...
            <textarea
              ...
              className="flex min-h-[100px] w-full rounded-lg border border-gray-800 bg-black px-4 py-3 text-sm text-white transition-all duration-300 placeholder:text-gray-400 focus:border-weethub-yellow focus:outline-none focus:ring-2 focus:ring-weethub-yellow/20 disabled:cursor-not-allowed disabled:opacity-50"
            />
          </LabelInputContainer>
        </motion.div>

        <motion.button
          className="group relative block h-12 w-full rounded-lg bg-gradient-to-r from-weethub-yellow to-yellow-500 font-medium text-black shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105"
          type="submit"
